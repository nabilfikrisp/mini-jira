...
export default function Sidebar({ username }: SidebarProps) {
  ...
  return (
    <>
      ...
      {/* Sidebar */}
      <div
        className={`fixed left-0 top-0 z-40 flex h-screen flex-col overflow-hidden border-r border-r-my-paragraph bg-my-bg text-my-paragraph transition-all duration-300 ease-in-out lg:sticky lg:w-52 lg:min-w-52 ${
